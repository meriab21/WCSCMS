      ...
      <v-form class="ma-12" v-model="form">
        ...
        <v-card>
          ...
          <v-card-text>
            ...
            >
              1. If your complaint is Emergency= choose Operation Maintenance.
            </div>
          </v-card-text>
          <v-card-text>
            <div
              style="font-family: sans-serif; font-size: 17px; font-weight: lighter; margin-bottom: 0;"
            >
              2.If your complaint is curruption= choose Customer Service.
            </div>
          </v-card-text>
          <v-card-text>
            <div
          ...
          <v-card-text>
            <div
              style="font-family: sans-serif; font-size: 17px; font-weight: lighter; margin-bottom: 0;"
            >
              4. If your complaint is Bill Unavailable= choose Customer Service.
            </div>
          </v-card-text>
          <v-card-text>
            <div
              style="font-family: sans-serif; font-size: 17px; font-weight: lighter; margin-bottom: 0;"
            >
              5. If your complaint is New Connection Delay= choose Operation
              Maintenance.
            </div>
          </v-card-text>
          <v-card-text>
          ...
          <v-card-text>
            <div
              style="font-family: sans-serif; font-size: 17px; font-weight: lighter; margin-bottom: 0;"
            >
              7. If your complaint is Manintenance Problem= choose Operation
              Maintenance.
            </div>
          </v-card-text>
          <v-card-text>
            <div
              style="font-family: sans-serif; font-size: 17px; font-weight: lighter; margin-bottom: 0;"
            >
              8. If your complaint is Unsatisfaied by Service= choose Customer
              Service.
            </div>
          </v-card-text>
          <v-card-text>
            <div
              style="font-family: sans-serif; font-size: 17px; font-weight: lighter; margin-bottom: 0;"
            >
              9. If your complaint is Unqualified Employee= choose Customer
              Service.
            </div>
          </v-card-text>
        </v-card>
...
export default {
  data() {
    return {
      ...
      department: "",
      items2: ["Operation_Mn", "Customer Service"],
      description: "",
    };
  },
