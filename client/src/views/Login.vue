<template>
  <v-container class="my-8">
    <v-card class="mx-auto mp-auto" style="max-width: 400px;">
      ...
      <v-form ref="form" v-model="form" class="pa-6 pt-8">
        <v-text-field
          v-model="email"
          filled
          color="deep-purple"
        ...
        <v-checkbox :rules="[rules.required]" color="deep-purple">
      ...
      <v-divider></v-divider>
      <v-card-actions>
        <v-btn color="success" route to="/Customer" @click="$refs.form.reset()">
          Login
        </v-btn>
